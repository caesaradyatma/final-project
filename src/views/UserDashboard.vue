  ...
  <div class="dashboard">
    <section>
      <div class="row">
        ...
        <div class="col-sm-5">
          <div class="prifle-picture">
            <img src="https://www.ludoviccareme.com/files/image_211_image_fr.jpg" alt="profile picture" class="profile-picture">
          </div>
        </div>
        <div class="col-sm-7">
...
<script>
import CardInv from '@/components/posts/CardInverted.vue';
